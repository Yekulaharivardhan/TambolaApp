...
if (document.getElementById(j).style.backgroundColor == '#C74B50') {
    document.getElementById(j).style.backgroundColor = '#05595B';
  } else if (button != '') {
    document.getElementById(j).style.backgroundColor = '#C74B50';
  }

}


const targetButton = document.getElementById("ticket")

targetButton.addEventListener("click", e => {
  console.log((e.target).innerHTML)

  if (((e.target).innerHTML) != '') {
    (myVariable.push((e.target).innerHTML))
